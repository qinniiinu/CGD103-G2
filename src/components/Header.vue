    ...
    <header>
        <div class="header_box">
            ...
            <nav class="main_nav">
                <ul class="main">
                    <li class="main_list">
                        <router-link to="/FindStyle" @click="check = false"
                            >找風格</router-link
                        >
                        <ul class="sub">
                            <li>
                                <router-link to="/MulStyles"
                                    >風格穿搭</router-link
                                >
                            </li>
                            <li>
                                <router-link to="/Wearing"
                                    >穿搭列表</router-link
                                >
                            </li>
                            <li>
                                <router-link to="/Quiz">風格測驗</router-link>
                            </li>
                            <li>
                                <router-link to="/Chat">風格諮詢</router-link>
                            </li>
                        </ul>
                    </li>
                    <li class="main_list">
                        <router-link to="/product" @click="check = false"
                            >逛商品</router-link
                        >
                        <ul class="sub">
                            <li>
            ...
            <ul class="sub">
              ...
              <li><router-link to="/">我的OOTD</router-link></li>
                    ...
                    <li class="main_list">
                        <router-link to="/subscription" @click="check = false"
                            >穿搭訂閱</router-link
                        >
                        <ul class="sub">
                    ...
                    <li class="main_list">
                        <router-link to="/about" @click="check = false"
                            >關於我們</router-link
                        >
                        <ul class="sub">
                            <li>
                                <router-link to="/about">品牌精神</router-link>
                            </li>
                            <li>
                                <router-link to="/about/#contactMe"
                                    >廠商洽談</router-link
                                >
                            </li>
...
header {
    ...
    box-shadow: 0.5px 0px 3px 0.5px rgb(0, 0, 0, 0.1);
    position: sticky;
    top: 0;
    z-index: 999999;
    .header_box {
