...
export default {
    ...
    methods: {
        cal() {
            ...
            if (
                this.shoulder / this.hip >= 1.05 &&
                this.chest / this.hip >= 1.05
            ) {
                X = 101;
                console.log(X);
            }
            // 矩形/柱形（腰圍 ÷ 肩部或胸圍 ≥ .75） 並且您的胸圍和臀圍測量值彼此相差在 5% 以內
                ...
                this.waistline / this.shoulder >= 0.75 &&
                this.waistline / this.chest >= 0.75
            ) {
                X = 102;
                console.log(X);
            }
            //      三角形/梨形（臀部 ÷ 肩部或胸圍 ≥ 1.05）
                ...
                this.hip / this.shoulder >= 0.75 &&
                this.hip / this.chest >= 0.75
            ) {
                X = 104;
                console.log(X);
            }
        ...
        validateEmail() {
            ...
            // 檢查 eamil 格式
            if (EMAIL_REGEX.test(this.mem_mail)) {
                // 電子郵件格式正確
